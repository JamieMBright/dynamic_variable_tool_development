function [alpha_b1,alpha_b2,beta_b1,beta_b2,alpha_b1_confidence,alpha_b2_confidence,beta_b1_confidence,beta_b2_confidence,AOD700,AOD700_confidence]=PostProcessingOfModisAOD(data,latitudes_HDF,longitudes_HDF,land_mask)
...
%% Derive the AOD700 variable from the remaining values.
AOD700=exp(log(AOD660)-log(700/660).*alpha_b1);
AOD700(isnan(AOD700))=exp(log(AOD870(isnan(AOD700)))-log(700/870).*alpha_b2(isnan(AOD700)));
AOD700(isnan(AOD700))=exp(log(AOD550(isnan(AOD700)))-log(700/550).*alpha_b2(isnan(AOD700)));
AOD700_confidence=zeros(size(AOD700));
AOD700_confidence(~isnan(AOD700))=1;
AOD700=REST2FillMissing(land_mask,longitudes_HDF,latitudes_HDF,AOD700);
